...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = `<speak>
                                <voice name="Amy">
                                    Hello <break strength="weak"/> I am farrrukh weather assistance
                                    <break strength="weak"/>
    ...
    async handle(handlerInput) {
        ...
        return await axios
                    ...
                    .then((response) => {
                        ...
                        const speak = `<speak>
                                <voice name="Amy">
                                    currently in ${cityWeather.name}, its ${cityWeather.main.temp} degree.
                                    and mostly ${cityWeather.weather[0].main}.
                                    today you fell higher ${cityWeather.main.temp_max} degree and lower ${cityWeather.main.temp_min} degres
                                </voice>
                            </speak>`
